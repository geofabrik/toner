...
#    },
    ...
    7: {
        'directory': 'ne_50m_land',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/50m/physical/ne_50m_land.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_50m_land'],
        'long_opt': '--ne-50m-land'
    },

    8: {
        'directory': 'ne_50m_admin_0_countries_lakes',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/50m/cultural/ne_50m_admin_0_countries_lakes.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_50m_admin_0_countries_lakes'],
        'long_opt': '--ne_50m_admin_0_countries_lakes'
    },

    9: {
        'directory': 'ne_10m_admin_0_countries_lakes',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/cultural/ne_10m_admin_0_countries_lakes.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_10m_admin_0_countries_lakes'],
        'long_opt': '--ne_10m_admin_0_countries_lakes'
    },

    10: {
        'directory': 'ne_10m_admin_0_boundary_lines_map_units',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/cultural/ne_10m_admin_0_boundary_lines_map_units.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_10m_admin_0_boundary_lines_map_units'],
        'long_opt': '--ne_10m_admin_0_boundary_lines_map_units'
    },

    11: {
        'directory': 'ne_50m_admin_1_states_provinces_lines',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/50m/cultural/ne_50m_admin_1_states_provinces_lines.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_50m_admin_1_states_provinces_lines'],
        'long_opt': '--ne_50m_admin_1_states_provinces_lines'
    },
    ...
    12: {
        ...
        'long_opt': '--ne_10m_admin_1_states_provinces_lines'
    },

    13: {
        'directory': 'ne_50m_admin_0_boundary_lines_land',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/50m/cultural/ne_50m_admin_0_boundary_lines_land.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_50m_admin_0_boundary_lines_land'],
        'long_opt': '--ne_50m_admin_0_boundary_lines_land'
    },
    ...
    14: {
        ...
        'long_opt': '--ne_10m_admin_0_boundary_lines_land'
    },

    15: {
        'directory': 'ne_50m_lakes',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/50m/physical/ne_50m_lakes.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_50m_lakes'],
        'long_opt': '--ne_50m_lakes'
    },
    ...
    16: {
        ...
        'long_opt': '--ne_10m_lakes'
    },

    17: {
        'directory': 'ne_10m_roads',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/cultural/ne_10m_roads.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_10m_roads'],
        'long_opt': '--ne_10m_roads'
    },

    18: {
        'directory': 'ne_10m_airports',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/cultural/ne_10m_airports.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_10m_airports'],
        'long_opt': '--ne_10m_airports'
    },

    19: {
        'directory': 'ne_110m_geography_marine_polys',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/110m/physical/ne_110m_geography_marine_polys.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_110m_geography_marine_polys'],
        'long_opt': '--ne_110m_geography_marine_polys'
    },

    20: {
        'directory': 'ne_50m_geography_marine_polys',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/50m/physical/ne_50m_geography_marine_polys.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_50m_geography_marine_polys'],
        'long_opt': '--ne_50m_geography_marine_polys'
    },

    21: {
        'directory': 'ne_10m_geography_marine_polys',
        'url': 'http://www.naturalearthdata.com/http//www.naturalearthdata.com/download/10m/physical/ne_10m_geography_marine_polys.zip',  # noqa
        'type': 'zip_dir',
        'shp_basename': ['ne_10m_geography_marine_polys'],
        'long_opt': '--ne_10m_geography_marine_polys'
    }
